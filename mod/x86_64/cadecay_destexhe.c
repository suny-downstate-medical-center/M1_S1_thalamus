...
#define nrn_init _nrn_init__cadA1
#define _nrn_initial _nrn_initial__cadA1
#define nrn_cur _nrn_cur__cadA1
#define _nrn_current _nrn_current__cadA1
#define nrn_jacob _nrn_jacob__cadA1
#define nrn_state _nrn_state__cadA1
#define _net_receive _net_receive__cadA1 
#define state state__cadA1 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cadA1 /Users/joao/Research/Models/NetPyNE/M1/mod/x86_64/cadecay_destexhe.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/joao/Research/Models/NetPyNE/M1/mod/cadecay_destexhe.mod";
static const char* nmodl_file_text = 
