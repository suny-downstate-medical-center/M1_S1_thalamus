...
#define nrn_init _nrn_init__imthal
#define _nrn_initial _nrn_initial__imthal
#define nrn_cur _nrn_cur__imthal
#define _nrn_current _nrn_current__imthal
#define nrn_jacob _nrn_jacob__imthal
#define nrn_state _nrn_state__imthal
#define _net_receive _net_receive__imthal 
#define evaluate_fct evaluate_fct__imthal 
#define states states__imthal 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_imthal", _hoc_setdata,
 "exptable_imthal", _hoc_exptable,
 "evaluate_fct_imthal", _hoc_evaluate_fct,
 0, 0
};
#define _f_exptable _f_exptable_imthal
#define exptable exptable_imthal
...
#define taumax taumax_imthal
 double taumax = 1000;
#define usetable usetable_imthal
 double usetable = 1;
 ...
 "taumax_imthal", &taumax_imthal,
 "usetable_imthal", &usetable_imthal,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 imthal /Users/joao/Research/Models/NetPyNE/M1/mod/x86_64/IM_cortex.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/joao/Research/Models/NetPyNE/M1/mod/IM_cortex.mod";
static const char* nmodl_file_text = 
  ...
  ":	Contributers: Erica Griffith, Dec 2019; modified suffix to imthal for use in A1 cortical model\n"
  "\n"
