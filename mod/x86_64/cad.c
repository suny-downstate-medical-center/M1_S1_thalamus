...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cad /Users/joao/Research/Models/NetPyNE/M1/mod/x86_64/cad.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/joao/Research/Models/NetPyNE/M1/mod/cad.mod";
static const char* nmodl_file_text = 
  "\n"
  ...
  "	\n"
  "BREAKPOINT {\n"
  "	SOLVE state METHOD derivimplicit : euler\n"
  "}\n"
  "\n"
  "DERIVATIVE state { \n"
  "\n"
