...
#define nrn_init _nrn_init__DynamicNetStim
#define _nrn_initial _nrn_initial__DynamicNetStim
#define nrn_cur _nrn_cur__DynamicNetStim
#define _nrn_current _nrn_current__DynamicNetStim
#define nrn_jacob _nrn_jacob__DynamicNetStim
#define nrn_state _nrn_state__DynamicNetStim
#define _net_receive _net_receive__DynamicNetStim 
#define init_sequence init_sequence__DynamicNetStim 
#define next_invl next_invl__DynamicNetStim 
#define noiseFromRandom noiseFromRandom__DynamicNetStim 
#define seed seed__DynamicNetStim 
...
#define fflag _p[7]
#define event _p[8]
#define last_interval _p[9]
#define transition _p[10]
#define on _p[11]
#define ispike _p[12]
#define v _p[13]
#define _tsav _p[14]
...
#define erand erand_DynamicNetStim
#define invl invl_DynamicNetStim
 extern double erand( _threadargsproto_ );
 extern double invl( _threadargsprotocomma_ double );
 /* declare global and static user variables */
#define check_interval check_interval_DynamicNetStim
 ...
 "check_interval_DynamicNetStim", "ms",
 "interval", "ms",
 "start", "ms",
 0,0
};
 ...
 "check_interval_DynamicNetStim", &check_interval_DynamicNetStim,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 DynamicNetStim /Users/joao/Research/Models/NetPyNE/M1/mod/x86_64/DynamicNetStim.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/joao/Research/Models/NetPyNE/M1/mod/DynamicNetStim.mod";
static const char* nmodl_file_text = 
