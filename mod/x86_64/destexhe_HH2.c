...
#define nrn_init _nrn_init__hh2des
#define _nrn_initial _nrn_initial__hh2des
#define nrn_cur _nrn_cur__hh2des
#define _nrn_current _nrn_current__hh2des
#define nrn_jacob _nrn_jacob__hh2des
#define nrn_state _nrn_state__hh2des
#define _net_receive _net_receive__hh2des 
#define evaluate_fct evaluate_fct__hh2des 
#define states states__hh2des 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_hh2des", _hoc_setdata,
 "Exp_hh2des", _hoc_Exp,
 "evaluate_fct_hh2des", _hoc_evaluate_fct,
 "states_hh2des", _hoc_states,
 "vtrap_hh2des", _hoc_vtrap,
 0, 0
};
#define Exp Exp_hh2des
#define vtrap vtrap_hh2des
 ...
 "gnabar_hh2des", "mho/cm2",
 "gkbar_hh2des", "mho/cm2",
 "vtraub_hh2des", "mV",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "k_ion");
 	...
 	ivoc_help("help ?1 hh2des /Users/joao/Research/Models/NetPyNE/M1/mod/x86_64/destexhe_HH2.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("hh2des", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 68 in file destexhe_HH2.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 }  }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/joao/Research/Models/NetPyNE/M1/mod/destexhe_HH2.mod";
static const char* nmodl_file_text = 
