...
#define nrn_init _nrn_init__iL
#define _nrn_initial _nrn_initial__iL
#define nrn_cur _nrn_cur__iL
#define _nrn_current _nrn_current__iL
#define nrn_jacob _nrn_jacob__iL
#define nrn_state _nrn_state__iL
#define _net_receive _net_receive__iL 
#define rates rates__iL 
#define states states__iL 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_iL", _hoc_setdata,
 "rates_iL", _hoc_rates,
 "vtrap_iL", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_iL
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 iL /Users/joao/Research/Models/NetPyNE/M1/mod/x86_64/ICal.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "high-threshold calcium (L-) current from hippocampal pyramidal cells";
...
static int  rates ( _threadargsproto_ ) {
   double _la , _lb ;
  _la = 1.6 / ( 1.0 + exp ( - 0.072 * ( v - 5.0 ) ) ) ;
   _lb = 0.02 * vtrap ( _threadargscomma_ - ( v - 1.31 ) , 5.36 ) ;
   mtau = 1.0 / ( _la + _lb ) / tadj ;
   minf = 1.0 / ( 1.0 + exp ( ( v + 10.0 ) / - 10.0 ) ) ;
    return 0; }
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ica = pca * pow( m , 2.0 ) * nrn_ghk ( v , cai , cao , 2.0 ) ;
   }
 _current += ica;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/joao/Research/Models/NetPyNE/M1/mod/ICal.mod";
static const char* nmodl_file_text = 
