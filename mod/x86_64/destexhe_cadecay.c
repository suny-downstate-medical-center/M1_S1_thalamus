...
#define nrn_init _nrn_init__caddes
#define _nrn_initial _nrn_initial__caddes
#define nrn_cur _nrn_cur__caddes
#define _nrn_current _nrn_current__caddes
#define nrn_jacob _nrn_jacob__caddes
#define nrn_state _nrn_state__caddes
#define _net_receive _net_receive__caddes 
#define state state__caddes 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 caddes /Users/joao/Research/Models/NetPyNE/M1/mod/x86_64/destexhe_cadecay.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/joao/Research/Models/NetPyNE/M1/mod/destexhe_cadecay.mod";
static const char* nmodl_file_text = 
