...
#define nrn_init _nrn_init__cada
#define _nrn_initial _nrn_initial__cada
#define nrn_cur _nrn_cur__cada
#define _nrn_current _nrn_current__cada
#define nrn_jacob _nrn_jacob__cada
#define nrn_state _nrn_state__cada
#define _net_receive _net_receive__cada 
#define state state__cada 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cada", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define cainf cainf_cada
 double cainf = 0.0001;
#define depth depth_cada
 double depth = 1;
#define taur taur_cada
 double taur = 20;
 ...
 "depth_cada", &depth_cada,
 "taur_cada", &taur_cada,
 "cainf_cada", &cainf_cada,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cada /Users/joao/Research/Models/NetPyNE/M1/mod/x86_64/Cadynamics.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double FARADAY = 96485.3;
static int _reset;
static char *modelname = "simple decay of internal calcium concentration";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/joao/Research/Models/NetPyNE/M1/mod/Cadynamics.mod";
static const char* nmodl_file_text = 
