...
cfg.saveFolder = '../data/v52_manualTune'
...
#------------------------------------------------------------------------------
cfg.analysis['plotRaster'] = {'include':['all'], 'orderBy': ['pop', 'y'], 'timeRange':[0,1000], 'saveFig': True, 'showFig': False, 'labels': 'overlay', 'popRates': True, 'orderInverse': True, 'figSize': (12,10),'lw': 0.3, 'markerSize':3, 'marker': '.', 'dpi': 300} 
cfg.analysis['plotTraces'] = {'include': [0], 'oneFigPer': 'trace', 'overlay': 1, 'figSize': (12,8), 'timeRange': [0,1000], 'saveFig': True, 'showFig': False,
...
cfg.netClampConnsFile = '../data/v52_manualTune/v52_tune4.json'
cfg.netClampSpikesFile = '../data/v52_batch11/v52_batch11_0_0.json'
cfg.netClampPop = ['PT5B_1']
cfg.netClampGid = 5234
cfg.netClampCreateAllConns = 0
