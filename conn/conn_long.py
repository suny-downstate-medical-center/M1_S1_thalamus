...
def plotPies():
    ...
    fracLabels['L'] = ['POm_sTC_m1', 'VL_sTC', 'S1', 'S2', 'cM1', 'M2', 'OC', 'Other']
...
fracSyns['M1']['VL_sTC'] = 0.15  # Thalamus, motor-related, ventro-lateral, core, Cerebellar-relaying
fracSyns['M1']['POm_sTC_m1'] = 0.15  # Thalamus, sensory-related, medial posterior, matrix; less syns thatn VL (Meyer 2011; Zhang 2016; Oh 2014; Bopp 2017)
...
#############
## Thalamus 
inputPops = ['POm_sTC_m1', 'VL_sTC']
normInput = {'Yama15elife': {},
            ('Yama15', 'IT'): {}, ('Yama15', 'PT'): {}, ('Yama15', 'CT'): {},
            ('Yama15', 'SOM'): {}, ('Yama15', 'PV'): {}, ('Yama15', 'VIP'): {}, ('Yama15', 'NGF'): {}}

## Yamawaki,2015 elife (forelimb)
normInput['Yama15elife']['POm_sTC_m1'] = [0.26, 0.72, 0.72, 0.58, 0.25, 0.090, 0.044, 0.022]
normInput['Yama15elife']['VL_sTC'] = [0.30, 0.43, 0.64, 0.24, 0.34, 0.77, 0.69, 0.061] 
normInput['Yama15elife']['VL_sTC'][4:7] = [np.mean(normInput['Yama15elife']['VL_sTC'][4:7])]*3  # make all L5B homogeneous as suggested by gordon 
...
## TPO (POm_sTC_m1) keep same values but adapted to use same structure as VL 
## Naka16 confirmed in Table 1: VL/PO->IT=low,high; VL/PO->PT=high,low 
normInput[('Yama15', 'PT')]['POm_sTC_m1'] = normInput['Yama15elife']['POm_sTC_m1'][4:6+1]  
normInput[('Yama15', 'PT')]['VL_sTC'] = [x*(0.914/0.6) for x in normInput['Yama15elife']['VL_sTC'][4:6+1]]  # PT = (0.914/0.6)*L5B
bins[('VL_sTC', 'PT')] = bins[('POm_sTC_m1', 'PT')] = bins['Yama15'][4:6+1]

normInput[('Yama15', 'CT')]['POm_sTC_m1'] = [normInput['Yama15elife']['POm_sTC_m1'][7]] * 2  # add extra L6 
normInput[('Yama15', 'CT')]['VL_sTC'] = [0.0457, 0.0457] # CT=0.0457 (derived from 3 eqn system above based on yamawaki jns ratios)
bins[('VL_sTC', 'CT')] = bins[('POm_sTC_m1', 'CT')] = bins['Yama15'][7:8+1]

normInput[('Yama15', 'IT')]['POm_sTC_m1'] = normInput['Yama15elife']['POm_sTC_m1'] + [normInput['Yama15elife']['POm_sTC_m1'][-1]]  # add extra L6 
normInput[('Yama15', 'IT')]['VL_sTC'] = normInput['Yama15elife']['VL_sTC'] + [normInput['Yama15elife']['VL_sTC'][-1]]  # add extra L6 bin 
normInput[('Yama15', 'IT')]['VL_sTC'][4:6+1] = [x*0.286/0.6 for x in normInput[('Yama15', 'IT')]['VL_sTC'][4:6+1]] # IT5B = (0.286/0.6)*L5B
normInput[('Yama15', 'IT')]['VL_sTC'][2] = np.mean(normInput[('Yama15', 'IT')]['VL_sTC'][0:2]) * (0.78/0.3) # increase TVL->L4 based on Yama15 Fig 6F: ratio of L2/3:L4 = 0.3:0.78
normInput[('Yama15', 'IT')]['VL_sTC'][7] = normInput[('Yama15', 'CT')]['VL_sTC'][0]*3 # IT6 upper = 3*CT;
normInput[('Yama15', 'IT')]['VL_sTC'][8] = normInput[('Yama15', 'CT')]['VL_sTC'][1] # IT6 lower = CT 
bins[('VL_sTC', 'IT')] = bins[('POm_sTC_m1', 'IT')] = bins['Yama15'][0:8+1]

bins[('VL_sTC', 'PV')] = bins[('VL_sTC', 'SOM')] = bins[('VL_sTC', 'VIP')] = bins[('VL_sTC', 'NGF')] = bins[('VL_sTC', 'IT')]
bins[('POm_sTC_m1', 'PV')] = bins[('POm_sTC_m1', 'SOM')] = bins[('POm_sTC_m1', 'VIP')] = bins[('POm_sTC_m1', 'NGF')] = bins[('POm_sTC_m1', 'IT')]

# add L1 NGF 
bins[('POm_sTC_m1', 'NGF')] = [[layers[0], layers[1]]] + bins[('POm_sTC_m1', 'NGF')]
bins[('VL_sTC', 'NGF')] = [[layers[0], layers[1]]] + bins[('POm_sTC_m1', 'NGF')]

## For inhib cells assume original Yamawaki elife yfrac-based values
normInput[('Yama15', 'SOM')]['POm_sTC_m1'] = normInput['Yama15elife']['POm_sTC_m1'] + [normInput['Yama15elife']['POm_sTC_m1'][-1]] # add extra L6 
normInput[('Yama15', 'PV')]['POm_sTC_m1'] = normInput['Yama15elife']['POm_sTC_m1'] + [normInput['Yama15elife']['POm_sTC_m1'][-1]]
normInput[('Yama15', 'VIP')]['POm_sTC_m1'] = normInput['Yama15elife']['POm_sTC_m1'] + [normInput['Yama15elife']['POm_sTC_m1'][-1]]
normInput[('Yama15', 'NGF')]['POm_sTC_m1'] = normInput['Yama15elife']['POm_sTC_m1'] + [normInput['Yama15elife']['POm_sTC_m1'][-1]]
normInput[('Yama15', 'SOM')]['VL_sTC'] = normInput['Yama15elife']['VL_sTC'] + [normInput['Yama15elife']['VL_sTC'][-1]]
normInput[('Yama15', 'PV')]['VL_sTC'] = normInput['Yama15elife']['VL_sTC'] + [normInput['Yama15elife']['VL_sTC'][-1]]
normInput[('Yama15', 'VIP')]['VL_sTC'] = normInput['Yama15elife']['VL_sTC'] + [normInput['Yama15elife']['VL_sTC'][-1]]
normInput[('Yama15', 'NGF')]['VL_sTC'] = normInput['Yama15elife']['VL_sTC'] + [normInput['Yama15elife']['VL_sTC'][-1]]
...
synsPerConn['POm_sTC_m1'] = 5
synsPerConn['VL_sTC'] = 5
...
## TPO (POm_sTC_m1) and TVL: L5B PT ~ 44% probability (Constantinople 2013) and 42.5% (Bruno 2006)
## set to ~2x max convergence = 600; tradeoff between reducing correlation vs computation time 
maxConv = 300

numCells['POm_sTC_m1'] = 2*maxConv  
numCells['VL_sTC'] = 2*maxConv
...
#    with open(outFolder+'conn_long.pkl', 'wb') as fileObj:        
    with open('conn_long.pkl', 'wb') as fileObj:
        pickle.dump(data, fileObj)

if saveMat:
#    savemat(outFolder+'conn_long.mat', data)
    savemat('conn_long.mat', data)
